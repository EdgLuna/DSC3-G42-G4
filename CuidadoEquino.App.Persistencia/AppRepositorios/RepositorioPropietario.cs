...
namespace CuidadoEquino.App.Persistencia
{
    public class RepositorioPropietario:INRepositorioPropietario
    {
        ...
        public RepositorioPropietario (AppContext AppContext) //Cosntructor Clase RepositorioPropietario
        {
            _AppContext=AppContext;
        }
        Propietario INRepositorioPropietario.AddPropietario(Propietario propietario)
        {
            var PropietarioAdicionado = _AppContext.Propietarios.Add(doctor);
