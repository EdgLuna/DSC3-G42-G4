...
namespace CuidadoEquino.App.Persistencia
{
    public class RepositorioEquino:INRepositorioEquino
    {
        ...
        {
            var EquinoEncontrado = _AppContext.Equinos.FirstOrDefault(e=>e.Id==idequino); //Id proviene de clase Persona por herencia
        ...
        {
            var EquinoEncontrado = _AppContext.Equinos.FirstOrDefault(e=>e.Id==equino.Id); //Id proviene de clase Persona por herencia
            if (EquinoEncontrado != null)
            {
